...
class EmogicTarotReader_Admin {
	...
	public static function register_settings_and_fields_for_admin_page(  ) {
		...
		$args = array(
				'type' => 'array',
				//'description' => 'ETSWP options',
				//'sanitize_callback' => 'sanitize_text_field',
				//'show_in_rest' => true,
				//'default' => NULL
				'default' => array(	'ETSWP_from_email_field' => 'tarot@tarot.emogic.com',		'ETSWP_email_display_name_field' => "Tarot Mailer2"		)
				);
		*/
		...
		//register_setting( 'ETSWP_option_group', 'ETSWP_options' , $args);
	...
	public static function email_display_name_field_render(  ) {
		...
		//$option = "";
		//if( isset($options["ETSWP_email_display_name_field"]) ){
			//$option = $options["ETSWP_email_display_name_field"];
		//}
		//name must be the option_name[option_field]
